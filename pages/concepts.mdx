...
The core principles around the architecture of Huddle01’s React SDK are what makes using it a breeze. Below are some concepts and glossary that you should be familiar with before using the SDK.
...
## Local
Once you join a room, all operations related to your own Peer object inside a room are represented by the keyword local.
