...
`localPeer` object from `huddleClient` allows you to interact with your own Peer object, which is how you are represented in the Huddle01 room.
...
localPeer.on("metadata-updated", () => {
  print("successfully updated remote peer metadata.");
});
