...
`joinRoom` from `useRoom` hook is used to join a room, but before that we have to create a room using [Create Room API](https://docs.huddle01.network/docs/apis/create-room/create-room).
