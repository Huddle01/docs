...
### Install Web3Auth Modal SDK and Huddle01 SDK
      ...
      <Tabs items={['pnpm', 'npm', 'yarn']}>
              <Tab>
                                                                                                                    ```bash 
    pnpm add @web3auth/modal @web3auth/base @huddle01/react@alpha @huddle01/server-sdk@alpha
    ```
            </Tab>
  <Tab>
                      ```bash 
    npm i @web3auth/modal @web3auth/base @huddle01/react@alpha @huddle01/server-sdk@alpha
    ```
            </Tab>
  <Tab>
                      ```bash 
    yarn add @web3auth/modal @web3auth/base @huddle01/react@alpha @huddle01/server-sdk@alpha
    ```
            </Tab>
              </Tabs>
