...
<div className="flex justify-between md:flex-row flex-col">
  <HighLight className="my-3 md:w-3/4 w-full">
    <RequestStrip
      method={'POST'}
...
<Paragraph className="mt-5">
  The Token Gated Room is a feature that allows you to create a room where access is restricted based on the type and value of a token. This means that only those who possess the required token can enter the room
