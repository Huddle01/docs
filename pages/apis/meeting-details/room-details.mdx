...
<div className="flex justify-between lg:flex-row flex-col">
  <HighLight className="my-3 w-full">
    <RequestStrip
      ...
      endpoint={"rooms/room-details/{roomId}"}
    />
  </HighLight>
</div>
...
<Pill >GET</Pill>
<div className="text-sm font-normal text-slate-50">`/rooms/room-details/{roomId}`</div>
...
<APIRequestCard
    requestType = "GET"
    route="/rooms/room-details/{roomId}"
    
  >
    <APIRequestContent value="cUrl">
      ```bash
        curl --location --request GET 'https://api.huddle01.com/api/v2/sdk/rooms/room-details/{roomId}' \
