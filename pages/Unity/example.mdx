...
- Get your project and API key from [here](https://docs.huddle01.network/docs/api-keys)
- You can generate room ID and token with our [Server SDK](https://docs.huddle01.network/docs/Server-SDK/api-functions)
