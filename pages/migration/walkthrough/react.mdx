...
This guide will help you migrate your existing React SDK i.e. `0.x.x` to the `1.x.x`.
...
- [Client Next JS Example](https://github.com/Huddle01/client-next-js-example)
- [Client Next TS Example](https://github.com/Huddle01/client-next-ts-example)
