...
Make sure that you are calling this API from server side. You can create an API route in `Next JS` or create an `Express` server. 
...
You can create an API route in `Next JS` or create an `Express` server to generate `accessToken`. 
