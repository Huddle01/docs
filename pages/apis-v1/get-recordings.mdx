...
Whatever recordings are created using the SDK, will be listed in the Get Recordings API, if you want to fetch the recordings for a particular meeting, you can pass the `meetingId` as a query parameter.
...
<Callout>
  `meetingId` is an optional parameter. To Fetch `meetingId` of a particular roomId. You can use the [Get Meeting API](/apis/meeting-details/meeting-list).
</Callout>
