...
{/* denyPeer */}
<div className="flex mt-5">
    <span className="font-mono font-semibold">3. denyPeer</span>
    <span className="ml-2">
        <Pill>Function</Pill>
    </span>
</div>
...
{/* getLobbyPeerMetadata */}
<div className="flex mt-5">
    <span className="font-mono font-semibold">4. getLobbyPeerMetadata</span>
    <span className="ml-2">
        <Pill>Function</Pill>
    </span>
</div>
...
<OptionTable
  ...
  options={[
    [
      'peerId',
      'string',
      'peerId of the waiting peer you want to join the room.',
      'Yes',
    ],
  ]}
/>
