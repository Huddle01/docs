...
To power your React Native app with audio/video communication using Huddle01 install the following:
      ...
      <Tabs items={['pnpm', 'npm', 'yarn']}>
              <Tab>
            ```bash 
      pnpm i @huddle01/react@beta @huddle01/server-sdk@beta react-native-get-random-values react-native-webrtc 
    ```
            </Tab>
  <Tab>
      ```bash 
    npm i @huddle01/react@beta @huddle01/server-sdk@beta react-native-get-random-values react-native-webrtc 
    ```
            </Tab>
  <Tab>
      ```bash 
    yarn add @huddle01/react@beta @huddle01/server-sdk@beta react-native-get-random-values react-native-webrtc 
    ```
            </Tab>
              </Tabs>
