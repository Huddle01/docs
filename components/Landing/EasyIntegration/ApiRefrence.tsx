...
const ApiRefrence = () => {
  ...
  return (
    <>
      <div>
        Integrate Huddle01 into your website or application with ease using our
        APIs. Create meeting rooms, fetch meeting details, and token-gate
        meeting rooms, using the different API endpoints provided by us at
        Huddle01.
      </div>
