...
export const showcaseData = [
  ...
  },
  {
    ...
    name: "Pixelmen",
    description:
      "A pixelated retro world where you can communicate with each other in real-time with spatial audio.",
  },
];
...
export const MigrationIndexData = [
  ...
  },
  {
    ...
    name: "Walkthrough",
    description:
      "This section provides a step-by-step guide on transitioning your current JavaScript, React, and React-Native SDK from version 0.x.x to the updated 1.x.x version.",
    icon: BookIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  },
  {
    ...
    name: "Hooks",
    description:
      "This section offers an overview of the newly introduced hooks in the 1.x.x version of the SDK, in comparison to the 0.x.x version of the SDK.",
    icon: PaperClipIcon,
    pattern: {
      y: 32,
      squares: [
